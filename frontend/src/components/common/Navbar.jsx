...
export function Navbar() {
  ...
  const {
    ...
    changeLanguage = () => {},
    toggleLanguage = () => {},
    currentLanguage = { code: 'en', label: 'English', native: 'English', flag: '🇬🇧' },
    t = (key) => key,
  } = useLanguage() || {};
          ...
          <div className="ce-nav-actions">
            ...
            <div className="ce-role-wrapper">
              <button
                ...
                className={`ce-nav-control ce-language-btn ${langMenuOpen ? 'border-blue-500/50 bg-blue-500/10' : ''}`}
              ...
              {langMenuOpen && (
                <div className="ce-role-dropdown w-56 max-h-[380px] overflow-y-auto z-50">
                  <div className="ce-role-dropdown-glow" />

                  <div className="ce-role-dropdown-header pb-2 mb-2 border-b border-slate-200 dark:border-slate-800">
                    <div className="ce-role-dropdown-icon">
                      <Globe className="w-4 h-4 text-blue-400" />
                    </div>
                    <div>
                      <p className="ce-role-dropdown-kicker">Language / भाषा</p>
                      <p className="ce-role-dropdown-title text-xs font-bold text-slate-800 dark:text-white">Choose Language</p>
                    </div>
                  </div>
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-medium transition-all ${
                            isSelected
                              ? 'bg-blue-600/15 text-blue-500 dark:text-blue-400 font-bold border border-blue-500/20'
            ...
            <div className="ce-mobile-menu-inner">
              ...
              <div className="ce-mobile-section">
                ...
                <div className="ce-mobile-control-grid">
                  ...
                  <div className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60">
                    <div className="flex items-center gap-2 mb-2 px-1">
                      <Globe className="w-3.5 h-3.5 text-blue-400" />
                      <span className="text-[11px] font-bold text-slate-700 dark:text-slate-300">Select Language / भाषा</span>
                    </div>
                    <div className="grid grid-cols-2 gap-1.5 max-h-36 overflow-y-auto">
                      {languages.map((l) => (
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-left transition-colors ${
                            l.code === lang
